...
const SignIn = () => {
    ...
    <div className={`parent h-auto w-full m-0 p-0`}>
        ...
        <div className="form-parent my-0 xl:h-[650] w-[100%] mx-auto flex justify-center relative z-10 mt-10">
            <form onSubmit={handleSignIn} className="form h-auto w-3/4 md:w-2/4 bg-[#f3f3f3] text-black flex flex-col rounded-[15px] relative p-0.5">
                <div className="form-heading w-3/4 h-8 mx-auto flex justify-center items-center mt-10">
                    ...
                    <p className="text-2xl hidden sm:block">Create a new vault</p>
                </div>
            ...
            <div className="h-[422px] w-full relative bottom-0 left-0 hidden sm:block">
                <svg className="h-[100%] w-[100%]" viewBox="0 0 1436 422" fill="none" xmlns="http://www.w3.org/2000/svg">
