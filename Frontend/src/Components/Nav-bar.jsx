...
const Navbar = () => {
    return (
        <div className="sm:flex justify-center p-0 m-0 w-[100%] max-w-[100%]">
            <nav
                className="w-[100%] sm:w-[90%] sm:shadow-[0px_4px_14px_0px_rgba(0,0,0,0.25)] md:h-[101px] lg:h-[101px] lg:w-[1253px] lg:max-w-[1253px] 
                xl:h-[123px] xl:w-[1395px] xl:max-w-[1395px] sm:m-[19px] sm:py-[32px] sm:px-[39px] sm:border-4 sm:border-[#a6a6a6] sm:rounded-[36px] bg-[#fcff31] sm:bg-[#f2f2f2] flex sm:justify-between items-center">
                <div className="hamburger-section justify-start flex sm:hidden">
                    <div className="hamburger-btn justify-self-center">
                        <svg width="69"
                            height="69"
                            viewBox="0 0 69 69"
                            fill="none"
                            ...
                            <path
                                d="M10.6701 22.0515H58.3299M10.6701 34.8556H58.3299M10.6701 47.6598H58.3299"
                                stroke="black"
                                strokeWidth="4"
                                strokeLinecap="round"
                ...
                <div className="My-vault hidden sm:block">
                    <a href="#" className="text-black decoration-[none]">
                        <button onClick={()=>window.location.href="/app"} className="navigation-button text-[20px] rounded-[36px] px-[36px] py-[13px] border-2 border-transparent transition-all duration-300 hover:shadow-[0_4px_12px_rgba(0,0,0,0.4)]">
                            My Vaults
                        </button>
                    </a>
                </div>
